        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-header">
                    Donasi Pembangan Masjid An-Nur
                </div>
                <div class="card-body">
                    <form action="<?= base_url('donasi/index') ?>" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="text ..">
                            <?= form_error('keterangan', '<small class="text-danger pl-3">', ' </small>') ?>
